...
\lstdefinestyle{mystyle}{
    ...
    showtabs=false,
    tabsize=2,
    % listings no digiere UTF-8 por si solo: mapeamos los acentos usados en los ejemplos
    extendedchars=true,
    inputencoding=utf8,
    literate=%
...
\begin{titlepage}
    ...
    \textbf{Autor:} \par
    \vspace{0.3cm}
    {\large Pablo Chantada Saborido \par}
    \textit{Login:} pablo.chantada \quad \textit{Email:} pablo.chantada@udc.es
    \vspace{0.5cm}
    
    \vfill
    
    % Fecha de entrega fijada: evita que una recompilacion posterior la desplace
    {\large 19 de diciembre de 2025 \par}
\end{titlepage}
